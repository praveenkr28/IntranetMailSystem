...
public class Serv_SeeMessage1 extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        try
        {
            ...
            for(rs = st.executeQuery("select mailfrom,mailto,subject,maildate,mailcc,mailbcc,maildata,mailst,mailid from newcompose where mailfrom='" + uname + "' and mailid=" + i); rs.next(); servletoutputstream.println("</form></body></html>"))
            {
                ...
                servletoutputstream.println("</td><td><a href=Serv_Sent>Inbox</a></td></tr></table><hr>");
                ...
                servletoutputstream.println("</td><td><a href=Serv_Sent>SentMail</a></td></tr></table>");
